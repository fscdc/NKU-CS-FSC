...
entry:
  ...
  %matrix = alloca [2 x [2 x i32]], align 4
...
loop_body:                                        ; preds = %loop
  %s_val = load float, float* %s, align 4
  %7 = load i32, i32* %3, align 4
  %yb = sitofp i32 %7 to float
  %8 = fadd float %s_val, %yb
  store float %8, float* %s, align 4
  %9 = load float, float* %s, align 4
  %10 = fcmp ogt float %9, 1.000000e+02
  %11 = fcmp olt float %9, 1.500000e+02
  %12 = and i1 %10, %11
  br i1 %12, label %loop_end, label %loop

loop_end:                                         ; preds = %loop_body, %loop
  %s_final = load float, float* %s, align 4
  %s_finalint = fptosi float %s_final to i32
  %matrix_val = load i32, i32* %4, align 4
