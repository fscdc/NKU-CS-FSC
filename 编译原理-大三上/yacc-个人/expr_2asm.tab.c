...
static const char *const yytname[] =
{
  ...
  "DIV", "LPT", "RPT", "ASSIGN", "NUMBER", "VAR", "UMINUS", "';'",
...
#line 62 "expr_2asm.y"
                               {
                    printf("    .text\n    .globl main\nmain:\n");
                    printf("%s", (yyvsp[-1].code).codechar);
                    // 清空 expr_usereg
                    memset(expr_usereg, 0, sizeof(expr_usereg));
                }
#line 1114 "expr_2asm.tab.c"
    break;

  case 5: /* stmt: VAR ASSIGN expr  */
#line 72 "expr_2asm.y"
                                {
                    int reg = search_reg((yyvsp[-2].code).codechar);
                    if (reg == -1) {//如果没找到，则给他分配一个寄存器
                        reg = add_reg((yyvsp[-2].code).codechar);
                    }
                    // 设置属性
                    memset((yyvsp[-2].code).codechar, 0, sizeof((yyvsp[-2].code).codechar));
                    (yyvsp[-2].code).reg = reg;
                    // 先计算 expr，再从结果寄存器中取出给 VAR 对应的寄存器
                    snprintf((yyval.code).codechar, 1000,"%sMOV R%d, R%d\n", (yyvsp[0].code).codechar, (yyvsp[-2].code).reg, (yyvsp[0].code).reg);
                }
#line 1130 "expr_2asm.tab.c"
    break;

  case 6: /* stmt: expr  */
#line 83 "expr_2asm.y"
                     { (yyval.code) = (yyvsp[0].code); }
#line 1136 "expr_2asm.tab.c"
    break;
...
#line 86 "expr_2asm.y"
                    {
                    // 找未分配的寄存器
                    int reg = search_reg((yyvsp[0].code).codechar);
                    if (reg == -1) {
                        reg = add_reg((yyvsp[0].code).codechar);
                    }

                    // 直接设置
                    memset((yyval.code).codechar, 0, sizeof((yyval.code).codechar));
                    (yyval.code).reg = reg;
                }
#line 1152 "expr_2asm.tab.c"
    break;
...
#line 97 "expr_2asm.y"
                    ...
                    snprintf((yyval.code).codechar, 1000, "%s%sADD R%d, R%d, R%d\n", (yyvsp[-2].code).codechar, (yyvsp[0].code).codechar, (yyval.code).reg, (yyvsp[-2].code).reg, (yyvsp[0].code).reg);
                }
#line 1171 "expr_2asm.tab.c"
    break;

  case 9: /* expr: expr MINUS expr  */
#line 111 "expr_2asm.y"
                                {
                    // 找未保存变量的寄存器
                    int i;
                    for (i = 0; i < Mreg; i++) {
                    ...
                    snprintf((yyval.code).codechar, 1000, "%s%sSUB R%d, R%d, R%d\n", (yyvsp[-2].code).codechar, (yyvsp[0].code).codechar, (yyval.code).reg, (yyvsp[-2].code).reg, (yyvsp[0].code).reg);
                }
#line 1190 "expr_2asm.tab.c"
    break;

  case 10: /* expr: expr MUL expr  */
#line 125 "expr_2asm.y"
                                {
                    // 找未保存变量的寄存器
                    int i;
                    for (i = 0; i < Mreg; i++) {
                    ...
                    snprintf((yyval.code).codechar, 1000, "%s%sMUL R%d, R%d, R%d\n", (yyvsp[-2].code).codechar, (yyvsp[0].code).codechar, (yyval.code).reg, (yyvsp[-2].code).reg, (yyvsp[0].code).reg);
                }
#line 1209 "expr_2asm.tab.c"
    break;

  case 11: /* expr: expr DIV expr  */
#line 139 "expr_2asm.y"
                                {
                    // 找未保存变量的寄存器
                    int i;
                    for (i = 0; i < Mreg; i++) {
                    ...
                    snprintf((yyval.code).codechar, 1000, "%s%sDIV R%d, R%d, R%d\n", (yyvsp[-2].code).codechar, (yyvsp[0].code).codechar, (yyval.code).reg, (yyvsp[-2].code).reg, (yyvsp[0].code).reg);
                }
#line 1228 "expr_2asm.tab.c"
    break;

  case 12: /* expr: LPT expr RPT  */
#line 153 "expr_2asm.y"
                             { (yyval.code) = (yyvsp[-1].code); }
#line 1234 "expr_2asm.tab.c"
    break;

  case 13: /* expr: MINUS expr  */
#line 154 "expr_2asm.y"
                                        {
                    // 使用同一个寄存器
                    (yyval.code).reg = (yyvsp[0].code).reg;

                    // 对寄存器取反
                    snprintf((yyval.code).codechar, 1000, "%sNEG R%d\n", (yyvsp[0].code).codechar, (yyvsp[0].code).reg);

                }
#line 1247 "expr_2asm.tab.c"
    break;

  case 14: /* expr: NUMBER  */
#line 162 "expr_2asm.y"
                                {
                    // 找未保存变量的寄存器
                    int i;
                    for (i = 0; i < Mreg; i++) {
                    ...
                    snprintf((yyval.code).codechar, 1000, "MOV R%d, #%d\n", (yyval.code).reg, (yyvsp[0].intv));
                }
#line 1266 "expr_2asm.tab.c"
    break;


#line 1270 "expr_2asm.tab.c"
