...
#line 30 "expr.y"
                          { printf("%f\n", yyvsp[-1]); }
#line 1087 "expr.tab.c"
    break;

  case 5: /* expr: expr ADD expr  */
#line 35 "expr.y"
                          { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1093 "expr.tab.c"
    break;

  case 6: /* expr: expr MINUS expr  */
#line 36 "expr.y"
                            { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1099 "expr.tab.c"
    break;

  case 7: /* expr: expr MULT expr  */
#line 37 "expr.y"
                           { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1105 "expr.tab.c"
    break;

  case 8: /* expr: expr DIV expr  */
#line 38 "expr.y"
                          { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1111 "expr.tab.c"
    break;

  case 9: /* expr: LPT expr RPT  */
#line 39 "expr.y"
                          { yyval = yyvsp[-1]; }
#line 1117 "expr.tab.c"
    break;

  case 10: /* expr: MINUS expr  */
#line 40 "expr.y"
                                    { yyval =-yyvsp[0]; }
#line 1123 "expr.tab.c"
    break;

  case 11: /* expr: NUMBER  */
#line 41 "expr.y"
                  { yyval = yyvsp[0]; }
#line 1129 "expr.tab.c"
    break;
