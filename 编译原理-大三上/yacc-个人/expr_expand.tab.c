...
static const char *const yytname[] =
{
  ...
  "DIV", "LPT", "RPT", "NUMBER", "ID", "ASSIGN", "UMINUS", "';'",
  "$accept", "lines", "expr", "decl", YY_NULLPTR
};
...
{
      -4,    15,    -4,    22,    22,    -4,     9,    -4,     3,     8,
      -4,    -4,    30,    22,    22,    22,    22,    22,    -4,    -4,
      -4,    -1,    12,    12,    -4,    -4
};
...
static const yytype_int8 yytable[] =
{
      ...
      21,    22,    23,    24,    25,     2,    18,    16,    17,     3,
      13,    19,     4,     0,     5,     6,     3,     0,     7,     4,
       0,     5,    10,    14,    15,    16,    17,     0,    20
};

static const yytype_int8 yycheck[] =
{
       3,     4,     3,     4,     5,     6,     3,     4,     5,     6,
      13,    14,    15,    16,    17,     0,    13,     5,     6,     4,
      11,    13,     7,    -1,     9,    10,     4,    -1,    13,     7,
      -1,     9,    10,     3,     4,     5,     6,    -1,     8
};
...
{
       0,    15,     0,     4,     7,     9,    10,    13,    16,    17,
      10,    16,    16,    11,     3,     4,     5,     6,    13,    13,
       8,    16,    16,    16,    16,    16
};
...
#line 37 "expr_expand.y"
                               {
                    printf("%f\n", yyvsp[-1]);
                }
#line 1102 "expr_expand.tab.c"
    break;

  case 3: /* lines: lines decl ';'  */
#line 40 "expr_expand.y"
                               {//这里我额外添加了一个赋值的功能，如果识别成声明则会赋值语句，例如a=1+3;可以被识别成赋值，可以看下面的decl的规则
                    printf("标识符成功赋值为%f\n", yyvsp[-1]);
                }
#line 1110 "expr_expand.tab.c"
    break;

  case 6: /* expr: expr ADD expr  */
#line 47 "expr_expand.y"
                                {
                    yyval = yyvsp[-2] + yyvsp[0];
                }
#line 1118 "expr_expand.tab.c"
    break;

  case 7: /* expr: expr MINUS expr  */
#line 50 "expr_expand.y"
                                  {
                    yyval = yyvsp[-2] - yyvsp[0];
                }
#line 1126 "expr_expand.tab.c"
    break;

  case 8: /* expr: expr MULT expr  */
#line 53 "expr_expand.y"
                                { 
                    yyval = yyvsp[-2] * yyvsp[0];
                }
#line 1134 "expr_expand.tab.c"
    break;

  case 9: /* expr: expr DIV expr  */
#line 56 "expr_expand.y"
                                {
                    yyval = yyvsp[-2] / yyvsp[0];
                }
#line 1142 "expr_expand.tab.c"
    break;

  case 10: /* expr: LPT expr RPT  */
#line 59 "expr_expand.y"
                                { yyval=yyvsp[-1]; }
#line 1148 "expr_expand.tab.c"
    break;

  case 11: /* expr: MINUS expr  */
#line 60 "expr_expand.y"
                                          {yyval=-yyvsp[0];}
#line 1154 "expr_expand.tab.c"
    break;

  case 12: /* expr: NUMBER  */
#line 61 "expr_expand.y"
                        {yyval=yyvsp[0];}
#line 1160 "expr_expand.tab.c"
    break;

  case 13: /* expr: ID  */
#line 62 "expr_expand.y"
                   {
                    int index = yyvsp[0];
                    yyval=sym[index].value;
        }
#line 1169 "expr_expand.tab.c"
    break;

  case 14: /* decl: ID ASSIGN expr  */
#line 68 "expr_expand.y"
                                   {
                    int index = yyvsp[-2];
                    sym[index].value = yyvsp[0];
                    yyval=yyvsp[0];
                }
#line 1179 "expr_expand.tab.c"
    break;


#line 1183 "expr_expand.tab.c"
